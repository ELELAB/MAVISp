...
class MAVISpSimpleMode(MAVISpMode):
    ...
    supported_modules = [ CancermutsTable,
                          ...
                          EVE,
                          AlphaMissense ]
    module_order = ['stability', 'local_interactions', 'local_interactions_DNA', 'local_interactions_homodimers', 'sas', 'cancermuts', 'ptms','mutsonphospho', 'long_range', 'functional_sites', 'clinvar', 'alphafold', 'demask', 'gemme', 'eve', 'alphamissense']
